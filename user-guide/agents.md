...
Select the language your agent should respond in. Hay supports 33 languages at the backend, with 14 languages (plus an inherit-from-organization option) available in the dashboard language picker.
